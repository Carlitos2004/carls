# ============================================================
#  server.py — API Flask para Vasconcellos Automotriz
#  Versión lista para LOCAL y NUBE (Railway / MySQL)
# ============================================================
...
def get_db():
    ...
    - En LOCAL usa localhost, root, 2004, inventario_automotriz
    - En NUBE usará las variables de entorno (Railway)
    """
    host = os.environ.get("MYSQLHOST", "localhost")
    user = os.environ.get("MYSQLUSER", "root")
    password = os.environ.get("MYSQLPASSWORD", "2004")
    database = os.environ.get("MYSQLDATABASE", "inventario_automotriz")
...
def productos_put(id):
    ...
    cur.execute("""
        ...
        WHERE id=%s
    """, (data["nombre_producto"], data["etiqueta"], data["stock"],
          data["precio"], id))
